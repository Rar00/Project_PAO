...
int main() {
    ...
    for (int i = 0; i<90000;i++)
        //for i=0;i<90000;i++ and   plaintext="123456789"+plaintext;
        //Done initial encryption and decryption in 1432 ms
        //Found key through bruteforce in 1094 ms
        //All with -O0 and -O7
        plaintext="123456789"+plaintext;
    std::cout<<"Finished creating text"<<std::endl;
    //cin>>keytext;
    bitset<32> test_key=99;
    string keytext=test_key.to_string();
    cout<<"Keytest="<<keytext<<endl;
    string good_key=keytext;
//    keytext="100000000000000000000000000000000";
 ...
 //   cout<<"Decripted text="<<total_dec<<endl;
 //   cout<<"Encripted text="<<total_enc<<endl;
    auto stop = std::chrono::steady_clock::now();
    std::cout << "Done initial encryption and decryption in " << std::chrono::duration_cast<std::chrono::milliseconds >(stop-start).count() << " ms" << std::endl;
